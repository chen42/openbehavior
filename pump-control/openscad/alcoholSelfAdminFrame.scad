...
//		translate([101,0,0])cube([2,2,200],center=true); // location finder
	...
	difference(){
       ...
       difference()
		...
		translate([101-14,max_d/2,19]) rotate([90,0,0]) round_corner_box(r0=1, wd=14,lg=10, ht=21); // power cord 
		//translate([60,max_d/2,6]) rotate([90,0,0]) round_corner_box(r0=1, wd=10,lg=10, ht=14); // wire hole 
		translate([0,max_d/2,5]) rotate([90,0,0]) round_corner_box(r0=1, wd=25,lg=10, ht=14); // wire hole 
...
module drillholes() //all four screw holes
{
